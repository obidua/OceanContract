...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-dark-950 via-dark-900 to-dark-950">
      ...
      {/* Hero Section */}
      <section className="pt-36 sm:pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            <div className="inline-block mb-6">
              <div className="cyber-glass border-2 border-cyan-500/50 rounded-full px-6 py-2 inline-flex items-center gap-2">
                <Zap className="text-neon-green" size={20} />
                <span className="text-cyan-300 text-sm font-medium">Next-Generation DeFi Ecosystem</span>
              </div>
            </div>
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-neon-green to-cyan-400">
                Dive Into The Future
              </span>
              <br />
              <span className="text-white">of Decentralized Finance</span>
            </h1>
            <p className="text-xl text-cyan-300/90 max-w-3xl mx-auto mb-10 leading-relaxed">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-bold text-cyan-300">OCEAN DeFi</span>
              </div>
              <p className="text-cyan-300/70 text-sm">
                Next-generation decentralized finance platform with multiple income streams
              </p>
            </div>
            <div>
              <h4 className="text-cyan-300 font-bold mb-4">Platform</h4>
            ...
            <div>
              <h4 className="text-cyan-300 font-bold mb-4">Learn</h4>
              <ul className="space-y-2">
                <li><Link to="/blockchain-basics" className="text-cyan-300/70 hover:text-neon-green transition-colors text-sm">Blockchain Basics</Link></li>
                <li><Link to="/what-is-defi" className="text-cyan-300/70 hover:text-neon-green transition-colors text-sm">What is DeFi?</Link></li>
                <li><Link to="/ramestta-blockchain" className="text-cyan-300/70 hover:text-neon-green transition-colors text-sm">Ramestta Blockchain</Link></li>
                <li><Link to="/rama-tokenomics" className="text-cyan-300/70 hover:text-neon-green transition-colors text-sm">RAMA Tokenomics</Link></li>
                <li><Link to="/validator-security" className="text-cyan-300/70 hover:text-neon-green transition-colors text-sm">Validator Security</Link></li>
              </ul>
            </div>
          </div>
          <div className="border-t border-cyan-500/20 pt-8 text-center">
            <p className="text-cyan-300/70 text-sm">
              © 2025 OCEAN DeFi. All rights reserved. Built on secure blockchain technology.
            </p>
          </div>
        </div>
      </footer>
